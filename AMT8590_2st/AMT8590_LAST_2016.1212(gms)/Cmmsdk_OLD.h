...
CMM_EXTERN long	(WINAPI *cmmIxxHelOnceSetSpeed)	(long Master, long SpeedMode, double WorkSpeed, double Acc, double Dec);
CMM_EXTERN long	(WINAPI *cmmIxxHelOnce) 		(long NumAxes, long* AxisList, double* CoordList, double ArcAngle, double *DistU, long IsBlocking);
CMM_EXTERN long	(WINAPI *cmmIxxHelOnceStart)	(long NumAxes, long* AxisList, double* CoordList, double ArcAngle, double *DistU);
