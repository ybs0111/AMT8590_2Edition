...
//                              LedState offState=LED_BUTTON_STATE_OFF);
	...
	//컨트롤로 내부에 LED이미지가 출력될 공간을 설정한다. (보통 10정도)
	//컨트롤러 내부의 넓이를 초과시 MAX Space는 최대의 값으로 자동 계산(설정 값 무시)
...
/////////////////////////////////////////////////////////////////////////////////////////////////
// 2006.09.14 kimgangmin 
// PushButton, CheckBox, RadioButton에 사용 가능한 LEDBUTTON class
//
// 1. Header files include  
// 2. 사용하고자 하는 <ICON>을 Resource에 등록
// 3. 적용할 컨트롤의 TPYE을 CLedButtond으로 변경
//
// 4. main functions
//    <variable>.SetIcons(UINT offIconId, UINT onIconId);   // ON/OFF시에 출력될 아이콘을 설정
//    <variable>.SetLedState(LedState check);               // LED on/off여부 (TRUE or FALSE)
//    <variable>.SetOffSet(UINT offset);                    // LED가 출력될 여백 설정
//
/////////////////////////////////////////////////////////////////////////////////////////////////
