...
BOOL CClockST::GetBitmapAndPalette(UINT nIDResource, CBitmap& bitmap, CPalette& pal)
{
	...
	hInstResource = AfxFindResourceHandle(MAKEINTRESOURCE(nIDResource), RT_BITMAP);  // 규이리 수정 (2002.09.04)
...
//		sprintf(szDate, "%02d-%02d-%04d", csTime.wDay, csTime.wMonth, csTime.wYear);
	...
	sprintf(szDate, "%04d-%02d-%02d", csTime.wYear, csTime.wMonth, csTime.wDay);
